...
"""drawByMoving.py: example of detecting stable position and draw a point. It is the basic algorithm needed for
defining entry and extir zones by moving around"""
...
class StartGUI:
    def __init__(self, master):
        self.device = None
        self.master = master
        master.title("Kinsei Sofa Detection")
